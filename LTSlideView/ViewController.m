...
- (void)selectorClassifyWithRow:(LTDownListView *)downListView classifyModel:(LTClassifyModel *)classifyModel indexPath:(NSIndexPath *)indexPath{
    
    NSLog(@" 选择之后区%ld 行%ld",indexPath.section,indexPath.row);
}
