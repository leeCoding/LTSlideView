...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //选择分类回调
    if ([self.delegate respondsToSelector:@selector(selectorClassifyWithRow:classifyModel:indexPath:)]) {
        [self.delegate selectorClassifyWithRow:self classifyModel:subkind indexPath:indexPath];
        //隐藏侧滑
        [self hideView];
    }
}
